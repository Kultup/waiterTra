...
- Кнопка **Завантажити Excel** на сторінці результатів ✅
- Фільтрація за містом для адмінів ✅
- Бібліотека: `xlsx` (для Excel) ✅

**Реалізовано:** Експорт у форматі .xlsx для всіх типів тестів.
...
- Модель `Quiz` та `QuizResult` ✅
- Сторінка **Quiz Builder** з медіа-підтримкою ✅
- Завантаження локальних файлів (фото/відео) ✅
- Оцінювання та розширені пояснення ✅
